...
REQUIRED = ("SKILL.md", "prompts/codebase-graph-business-rules.md", "agents/openai.yaml", "evals/eval.yaml", "evals/cases/basic-success.yaml", "evals/cases/edge-incomplete-input.yaml", "evals/cases/edge-scope-boundary.yaml", "references/graphify-and-evidence.md", "references/document-contract.md")
